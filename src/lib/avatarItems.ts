...
export const HAT_ITEMS: AvatarItem[] = [
  ...
  {
    id: 'hat_streak_master',
    name: 'Streak Master Crown',
    description: 'Earned through 60 days of dedicated collecting.',
    category: 'hat',
    rarity: 'legendary',
    icon: FireIcon,
  ...
  {
    id: 'hat_streak_legend',
    name: 'Legendary Streak Crown',
    description: 'The ultimate crown for 100-day streak collectors.',
    category: 'hat',
    rarity: 'legendary',
    icon: StarIcon,
...
export const FRAME_ITEMS: AvatarItem[] = [
  ...
  {
    id: 'frame_streak_diamond',
    name: 'Diamond Streak Frame',
    description: 'Two months of unwavering dedication.',
    category: 'frame',
    rarity: 'legendary',
    icon: SparklesIcon,
    gradient: 'from-cyan-400 via-blue-300 to-indigo-500',
    unlockRequirement: { type: 'streak', value: 60 },
    secondaryColor: '#06b6d4',
  },
  {
    id: 'frame_streak_legendary',
    name: 'Legendary Streak Frame',
    description: '100 days of legendary collecting!',
    category: 'frame',
    rarity: 'legendary',
    icon: StarIcon,
    gradient: 'from-rose-400 via-pink-300 to-purple-500',
    unlockRequirement: { type: 'streak', value: 100 },
...
export const BADGE_ITEMS: AvatarItem[] = [
  ...
  },
  {
    ...
    description: 'A full month of daily collecting!',
    category: 'badge',
    rarity: 'epic',
    icon: TrophyIcon,
  ...
  {
    id: 'badge_streak_60',
    name: 'Season Collector Badge',
    description: 'Two months of dedicated collecting!',
    category: 'badge',
    rarity: 'legendary',
    icon: SparklesIcon,
    gradient: 'from-purple-400 to-pink-500',
