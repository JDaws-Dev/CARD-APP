...
import { getTutorialContentForGame } from '@/lib/tutorialContent';
import {
  GradeLikeAProButton,
...
export default function LearnPage() {
  ...
  const isPokemon = primaryGame.id === 'pokemon';
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl">
              Learn to Collect {gameContent.gameName}
            </h1>
            <p className="text-sm text-gray-600 dark:text-slate-400">
              Guides{isPokemon ? ' and mini-games' : ''} to become a {gameContent.gameName} expert
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Pokémon TCG Mini-Games - Only shown when Pokémon is selected */}
      {isPokemon && (
        <>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Learn to recognize Pokémon TCG set symbols! Match symbols to their set names and
          ...
          <div className="mb-8 rounded-2xl border border-orange-200 bg-gradient-to-r from-orange-50 to-red-50 p-6 shadow-sm">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="mb-1 flex items-center gap-2">
                    <h2 className="text-xl font-bold text-gray-900">Pokémon Type Quiz</h2>
                    <span className="inline-flex items-center gap-1 rounded-full bg-emerald-100 px-2 py-0.5 text-xs font-medium text-emerald-700">
                      <StarIcon className="h-3 w-3" aria-hidden="true" />
                      Mini-Game
                    </span>
                  ...
                  <p className="text-gray-600">
                    Test your knowledge of Pokémon types! Look at cards and guess whether they&apos;re
