...
/**
 * Error page for individual set pages.
 * Handles errors when loading a specific set's cards.
 */
export default function SetDetailError({ error, reset }: ErrorPageProps) {
  useEffect(() => {
    console.error('Set detail page error:', error);
  }, [error]);
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-indigo-50 to-purple-50 p-8">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-lg">
        ...
        <h1 className="mb-3 text-2xl font-bold text-gray-800">Couldn&apos;t load this set</h1>

        <p className="mb-6 text-gray-500">
          We had trouble loading the cards in this set. The set might not exist, or there could be a
          temporary issue.
        </p>
