...
/**
 * Error page for the /sets route segment.
 * Handles errors when loading set data.
 */
export default function SetsError({ error, reset }: ErrorPageProps) {
  useEffect(() => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-indigo-50 to-purple-50 p-8">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-lg">
        ...
        <h1 className="mb-3 text-2xl font-bold text-gray-800">Couldn&apos;t load sets</h1>

        <p className="mb-6 text-gray-500">
          We had trouble loading the Pokemon card sets. This might be a temporary issue with the
          card database.
        </p>
